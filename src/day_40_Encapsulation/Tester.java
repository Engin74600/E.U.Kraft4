...
public class Tester {
    //bir sayfada 2 class olabilir ama 2 puplic olamaz.
    private String name;
    private double salary;

    private char gender;

    public String getName() {//get name için paremetre yok. sadece ulaşılmaz deişkeni ulaşır
        if (name == null) {
...
class TesterObjects { //bir sayfada 2 class olabilir ama 2 puplic olamaz.
